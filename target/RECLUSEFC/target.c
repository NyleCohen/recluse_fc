...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    DEF_TIM(TIM12, CH1, PA9, TIM_USE_PWM | TIM_USE_PPM,    0, 0 ), // S1_IN
    DEF_TIM(TIM12, CH2, PA8, TIM_USE_PWM,                  0, 0 ), // S2_IN
    DEF_TIM(TIM8,  CH1, PC9,  TIM_USE_PWM,                 0, 0 ), // S3_IN DMA2_ST2 DMA2_ST2
    DEF_TIM(TIM8,  CH2, PC8,  TIM_USE_PWM,                 0, 1 ), // S4_IN DMA2_ST3 DMA2_ST2
